...
> 作为一个摄影入门爱好者，我的工作流通常是：一通乱拍 -> 导出JPG和RAW文件 -> 通过JPG选片 （精选的拿来后期，不满意的删除，剩下的作为纯旅拍照片保留）
> 其中选片和分放JPG和RAW照片虽然有写bat脚本进行批处理，但还是要开多个文件夹窗口，每次都很耗费时间
> 出于简化个人工作流的考虑，也刚好赶上了AI时代，自己Vibe Coding了这个小工具用来选片
> 基础功能就是JPG选片和清理，AI附送的重命名，星标，地图功能本人并没有测试过，如果有问题还请见谅
> 
